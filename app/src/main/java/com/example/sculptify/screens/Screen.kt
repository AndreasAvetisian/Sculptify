...
sealed class Screen(val route: String) {
    ...
    data object WorkoutDetails : Screen("workoutDetail/{workoutID}/{focusArea}/{level}/{time}/{exercises}")
    data object Workout : Screen("workout/{workoutID}/{focusArea}/{level}/{time}/{exercises}/{cbs}")
